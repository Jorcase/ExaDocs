...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Crear',
        href: route('tipo-archivos.create'),
    },
];
                ...
                >
                    <div className="space-y-4">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <Textarea
                                id="descripcion"
                                placeholder="Descripción breve del tipo de archivo"
