...
export default function Index({
          ...
          return (
            <div className="flex w-full justify-end gap-2 pr-1">
              ...
              <ConfirmDelete
                ...
                description="El comentario se eliminará definitivamente de la base de datos."
              >
  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <Head title="Comentarios | Gestión" />
      <ListLayout
        title="Gestión de Comentarios"
        createHref={route('comentarios.create')}
        createLabel="Crear comentario"
        paginationLinks={comentarios.links}
        actions={
          <>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-1 gap-3 mt-1">
                      {[
                        ...
                        <label key={`destacado-${opt.label}`} className="flex items-center gap-2 text-sm cursor-pointer select-none">
                          <input
                            type="radio"
                            name="destacado"
                            className="h-4 w-4 border-input text-primary focus:ring-1 focus:ring-ring cursor-pointer"
            ...
            {openFilter || filtersState.search || filtersState.autor || filtersState.destacado !== null ? (
              <Button
                variant="secondary"
                className="rounded-lg"
                type="button"
